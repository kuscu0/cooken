...
- Almost none for every one, because simple & easy to use UI
...
### 3.3.2 MTTR 6h (during daytime)

### 3.3.3 Core functionality no bugs

### 3.3.4 All data on server, data isn't too important incase of data loss
...
### 3.4.1 avr: < 50ms max: < 5s

### 3.4.2 max users stored: 10k

### 3.4.3 max active users: 10%
...
#### 3.6.1 TODO from technology stack

### 3.7 On-line User Documentation and Help System Requirements
Help page with YT video
